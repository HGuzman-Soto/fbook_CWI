...
##########################################################################################################
    ...
    if(args.german):
        ...
        #temp resize
        word_parse_features = word_parse_features[:30]
        ...
        #temp store in csv
        word_parse_features = word_parse_features[['word','length','vowels','pos','ner','wikipedia_freq', 'learners_freq','subtitles_freq','google_freq']]
